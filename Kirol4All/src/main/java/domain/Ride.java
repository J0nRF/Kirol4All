...
public class Ride implements Serializable {
	...
	public Ride(Integer rideNumber, String from, String to, Date date, int nPlaces, float price, User driver) {
		super();
	...
	public Ride(String from, String to,  Date date, int nPlaces, float price, User driver) {
		super();
		this.from = from;
		this.to = to;
		this.nPlaces = nPlaces;
	...
	public String toString(){
		return rideNumber+";"+nPlaces+";"+from+";"+to+";"+date+";"+request;  
	}
